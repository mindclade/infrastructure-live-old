...
for required in (
    ...
    "5-workloads/ci/nodepools/runner/terragrunt.hcl",
    "5-workloads/ci/nodepools/runner/.terraform.lock.hcl",
    "5-workloads/ci/nodepools/runner-spot/terragrunt.hcl",
    "5-workloads/ci/nodepools/runner-spot/.terraform.lock.hcl",
    "5-workloads/ci/README.md",
    "5-workloads/ci/workstation-image-source/terragrunt.hcl",
    "5-workloads/ci/workstation-image-source/.terraform.lock.hcl",
    "scripts/validate-arc-runner-placement.py",
    "contracts/nix-binary-cache.json",
    "contracts/ci-activation-readiness.json",
    "scripts/validate-ci-activation-readiness.py",
    "scripts/sanitize-plan-classification.py",
    "docs/generated/ci-activation-readiness.md",
    ...
    "5-workloads/development/workstation/.terraform.lock.hcl",
