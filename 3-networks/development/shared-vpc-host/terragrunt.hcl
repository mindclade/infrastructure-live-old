...
# Shared VPC host network for development.
#
...
#
# The host project itself is created in 2-environments/development; this unit builds the network
...
dependency "shared" {
  ...
  mock_outputs = {
    project_ids = {
      net = "mc-development-net"
      ops = "mc-development-ops"
    }
  }
