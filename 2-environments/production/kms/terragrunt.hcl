...
# Cloud KMS key ring for production — rotation schedules, HSM protection.
#
...
#
#   projects/<seed>/locations/<region>/keyRings/<prefix>-production/cryptoKeys/storage
#
...
inputs = {
  ...
  key_ring_name = "${include.root.locals.prefix}-production"
