...
# Cloud KMS key ring for development — rotation schedules, HSM protection.
#
...
#
#   projects/<seed>/locations/<region>/keyRings/<prefix>-development/cryptoKeys/storage
#
...
inputs = {
  ...
  key_ring_name = "${include.root.locals.prefix}-development"
