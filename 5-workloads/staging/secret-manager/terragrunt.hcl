...
dependency "kms" {
  ...
  mock_outputs = {
    crypto_key_ids = {
      secrets = "projects/mock/locations/us-central1/keyRings/mock-staging/cryptoKeys/secrets"
    }
  }
  mock_outputs_allowed_terraform_commands = ["plan", "validate", "init"]
}
...
dependency "kms_dr" {
  ...
  mock_outputs = {
    crypto_key_ids = {
      secrets = "projects/mock/locations/us-east4/keyRings/mock-staging-dr/cryptoKeys/secrets"
    }
  }
  mock_outputs_allowed_terraform_commands = ["plan", "validate", "init"]
}
