...
inputs = {
  ...
  perimeter = {
    ...
    # DRY RUN
    # ------------------------------------------------------------------------------------
    # Staging enforces. This is the environment where a perimeter mistake should surface,
  ...
  egress_policies = [
    {
      ...
      # legitimate cross-perimeter read: an image promoted from staging is pulled by
