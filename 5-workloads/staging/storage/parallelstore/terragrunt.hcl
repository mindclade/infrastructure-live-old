...
dependency "vpc" {
  ...
  mock_outputs = {
    ...
    host_project_id   = "mc-staging-research"
  }
...
dependency "psc" {
  ...
  mock_outputs = {
    service_networking_ranges = { staging = "mc-staging-servicenetworking" }
  }
  mock_outputs_allowed_terraform_commands = ["plan", "validate", "init"]
}
...
inputs = {
  ...
  parallelstore = {
    scratch = {
      ...
      # 12 TiB is the minimum Parallelstore provisions. Staging runs do not need more,
