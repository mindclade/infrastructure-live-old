...
dependency "gke" {
  ...
  mock_outputs = {
    ...
    node_subnetwork = "mc-production-nodes"
  }
...
inputs = {
  ...
  # Production platform/control-plane capacity is deliberately non-preemptible.
  # Argo CD, policy, observability and reconcilers must not disappear because spare Spot
  # capacity was reclaimed by the provider.
  spot = false
