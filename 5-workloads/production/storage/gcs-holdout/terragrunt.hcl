...
dependency "workload_identities" {
  ...
  mock_outputs = {
    service_accounts = {
      preprocessing     = { email = "preprocessing@mc-production-research.iam.gserviceaccount.com" }
      training_h100     = { email = "training-h100@mc-production-research.iam.gserviceaccount.com" }
      training_b200     = { email = "training-b200@mc-production-research.iam.gserviceaccount.com" }
      holdout_evaluator = { email = "holdout-evaluator@mc-production-research.iam.gserviceaccount.com" }
    }
  }
  mock_outputs_allowed_terraform_commands = ["plan", "validate", "init"]
}
...
inputs = {
  ...
  buckets = {
    holdout = {
      ...
      # Object versioning plus soft delete even in production. Overwriting a holdout shard
