...
dependency "kms" {
  ...
  mock_outputs = {
    crypto_key_ids = {
      secrets = "projects/mock/locations/us-central1/keyRings/mock-development/cryptoKeys/secrets"
    }
  }
  mock_outputs_allowed_terraform_commands = ["plan", "validate", "init"]
}
...
dependency "kms_dr" {
  ...
  mock_outputs = {
    crypto_key_ids = {
      secrets = "projects/mock/locations/us-east4/keyRings/mock-development-dr/cryptoKeys/secrets"
    }
  }
  mock_outputs_allowed_terraform_commands = ["plan", "validate", "init"]
}
