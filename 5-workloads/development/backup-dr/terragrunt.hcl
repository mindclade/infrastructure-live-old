...
dependency "gke" {
  ...
  mock_outputs = {
    ...
    cluster_id   = "projects/mc-development-platform/locations/us-central1/clusters/mc-development"
  }
...
dependency "kms_dr" {
  ...
  mock_outputs = {
    crypto_key_ids = {
      storage = "projects/mock/locations/us-east4/keyRings/mock-development-dr/cryptoKeys/storage"
    }
  }
  mock_outputs_allowed_terraform_commands = ["plan", "validate", "init"]
}
