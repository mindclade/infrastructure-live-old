...
| GPU capacity | Terraform is the sole capacity authority for zonal H100 A3 Mega and H200 A3 Ultra pools; labels and taints match held Kueue flavors and both pools scale to zero | **Unknown:** qualify current regional support, reservations or queued capacity, quota, driver/fabric/topology, checkpoint/restart, and cost before raising Kubernetes and Kueue quotas |
